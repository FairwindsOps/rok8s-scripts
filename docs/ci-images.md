...
We currently include CI Images based on Alpine and Debian Buster as our recommended starting points. The latest Debian Buster release can be pulled from `quay.io/reactiveops/ci-images:v16.0-cimg-24.04`. A full list of image tags is available on our [Quay repository](https://quay.io/repository/reactiveops/ci-images).
...
**Deprecation Notice from 2026-09-08** Debian Bullseye has been deprecated. Please use cimg images.

## Upgrading from v16 to v17

v17 upgrades kind to `0.33.0` and the default kind node image to Kubernetes `1.37.0`. See [Versioning](versions.md) for the full list of breaking changes if you use Kubernetes e2e jobs.
